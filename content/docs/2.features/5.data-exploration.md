...
- **Manual trigger**: On the data source management page, select the target data source and click "Start Exploration", where you can configure:
  - **Data type**: Logs, metrics, or traces
  - **Application scope**: Specify the application or service to explore
  - **Time range**: Defaults to the last three days, or customize as needed
...
|-------------|-------------|----------------------|
| **service** | Stable identifier for a logical service or application, moderate cardinality, interpretable | `service.name`, `service`, `app`, `application` |

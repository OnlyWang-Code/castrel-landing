...
```mermaid
flowchart LR
    A[Initiate Troubleshooting]
    B[Collect Data]
    C[Fault Localization]
    D[Verify Hypothesis]
    E[Root Cause Analysis]

    subgraph X["Incident Knowledge Base"]
...
The first step in incident response is **confirming that the problem actually exists**, rather than wasting time on false alarms. AI can perform preliminary analysis the moment an alert triggers, helping users quickly determine whether this is a real incident or a false positive, and immediately launch deep investigation upon confirmation.

### Key Design Points

| Design Element | Description |
| :--- | :--- |
| **Instant Analysis** | After an alert triggers, AI automatically performs preliminary analysis, providing the basis for whether the alert needs attention |
| **Quick Confirmation** | Users quickly decide whether to escalate this alert to an incident for investigation based on AI's preliminary analysis |
| **One-Click Launch** | After confirmation, launch deep investigation with one click, without manually opening multiple systems to view data |

### Practical Recommendations

- **Distinguish Alerts from Incidents**: Not all alerts require deep investigation; AI's preliminary analysis helps users make this judgment
- **Lower Confirmation Barriers**: Push analysis results through IM tools like Slack, allowing users to confirm without logging into the console
- **Avoid Over-Automation**: Deep investigation consumes significant resources and requires explicit user authorization before starting

::callout{icon="i-lucide-trophy" color="primary"}
Let users determine whether intervention is needed in seconds, rather than spending minutes opening various monitoring systems.
::
...
![AI Analysis and Observability Data](/images/blog/ai-troubleshooting/ai-analysis.png)
...
![Human-AI Collaborative Troubleshooting](/images/blog/ai-troubleshooting/human-ai-collaboration.png)
...
| :--- | :--- |
| **Quick Confirmation** | Instant analysis after alert triggers, distinguishing false alarms from real incidents |
...
| **Narrowing Scope** | Even if root cause cannot be located, can rule out distractions and output key findings |
